...
import LightSideNav from '../LightSideNav/LightSideNav'
            ...
            <div className="nav">
              ...
              <div className="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                <nav className="sb-sidenav-menu-nested nav">
                  ...
                  <Link to="/lightStatic" className="nav-link">Static Navigation</Link>
                  <Link to={<LightSideNav/>} className="nav-link">Light Sidenav</Link>
                </nav>
              </div>
